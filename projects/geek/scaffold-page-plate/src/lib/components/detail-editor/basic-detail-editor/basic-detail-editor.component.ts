...
import { DialogFactoryService, ChangeIconDialogPlateComponent } from '@geek/scaffold-app-minor';
  ...
  changeIcon() {
    ...
    dialog.afterOpen().subscribe(() => {
      ...
      ins.afterConfirm$.pipe(switchMap(() => {
        ...
        return this.http.post(`${environment.serveBase}/files/UploadFormFile`, fusData.formData, { headers: fusData.header })
      })).subscribe((res: any) => {
