import { Component, OnInit, Injector, Inject, ViewChild, ViewContainerRef, ReflectiveInjector } from '@angular/core';
...
@Component({
  selector: 'app-lazy-module-confirm-dialog-plate',
  templateUrl: './lazy-module-confirm-dialog-plate.component.html',
  styleUrls: ['./lazy-module-confirm-dialog-plate.component.scss']
})
export class LazyModuleConfirmDialogPlateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let ins = this.lazyEntryContainer.createComponent(childComponent, 0, resolverInject).instance as IConfirmDialogComponentBase;
