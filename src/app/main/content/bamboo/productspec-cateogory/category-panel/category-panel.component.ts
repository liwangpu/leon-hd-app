...
export class CategoryPanelComponent implements OnInit, OnDestroy {
  ...
  constructor(private categorySrv: ProductspecCategoryService, private formBuilder: FormBuilder, private comFactory: ComponentFactoryResolver, private dessertSrv: DessertService, @Inject(MAT_DIALOG_DATA) private data: any, private dialogRef: MatDialogRef<CategoryPanelComponent>, private categoryMdSrv: CategoryMdService) {
