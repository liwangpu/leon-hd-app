...
import { CategoryNavExtend } from '../../paginator-left-category-common-tpls/paginator-left-category-common-tpls.component';
import { Subject } from 'rxjs';

@Component({
  selector: 'app-common-category-select-panel',
