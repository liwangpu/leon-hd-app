...
@NgModule({
    ...
    exports: [
        FuseContactsComponent, FuseContactsContactListComponent, FuseContactsContactFormDialogComponent, FuseContactsSelectedBarComponent, FuseContactsMainSidenavComponent
    ]
})
