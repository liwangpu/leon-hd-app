...
import { FassetService } from '../../../../server/webapi/fileasset.service';
...
export class PanelComponent implements OnInit, OnChanges {
  ...
  @Input() fileAsset: Array<FAsset> = [];//已有文件信息
  ...
  constructor(private renderer: Renderer, private authSrv: AuthService, private fileNamePipe: FilenamePipe, private downloadSrv: DownloadService, private dialogSrv: DialogService, private tanslateSrv: TranslateService, private fileSrv: FassetService, private snackBarSrv: SnackbarService) { }
