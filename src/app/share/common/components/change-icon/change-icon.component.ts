...
export class ChangeIconComponent implements OnInit, OnDestroy, ISimpleConfirm {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, protected pathSrv: PathService, protected config: ConfigService, private http: HttpClient, protected asyncHandle: AsyncHandleService, protected iconSrv: IconService) { }
