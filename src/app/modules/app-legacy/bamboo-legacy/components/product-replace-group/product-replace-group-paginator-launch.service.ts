...
import { PaginatorLaunch, ListDisplayModeEnum, AsyncHandleService, ProductReplaceGroupService, DialogFactoryService } from '@app/app-legacy';
...
export class ProductReplaceGroupPaginatorLaunchService extends PaginatorLaunch {
    ...
    pagedModel: Array<string> = ["product-replace-group"];
