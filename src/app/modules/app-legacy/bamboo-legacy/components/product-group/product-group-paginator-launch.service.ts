...
import { PaginatorLaunch, IListTableColumn, ProductGroupService, AsyncHandleService, DialogFactoryService, SimpleCategoryPanelComponent,ProductGroup } from '@app/app-legacy';
// import { ProductGroup } from '@app/app-legacy/models/product-group';
