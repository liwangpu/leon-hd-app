...
// import { PackageMaterial } from '@app/app-legacy/models/package-content-item';
import { AsyncHandleService, DialogFactoryService, PackageService, SimpleMessageContentComponent, PackageMaterial, Package } from '@app/app-legacy';
