...
import { PaginatorLaunch, IListTableColumn, ProductService, AsyncHandleService, DialogFactoryService, IAdvanceMenuItem, SimpleCategoryPanelComponent, PreferenceService, Product } from '@app/app-legacy';
