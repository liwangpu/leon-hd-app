...
// import { MediaShareResource } from '@app/app-legacy/models/media-share-resource';
import { WindowService, MediaShareService, AsyncHandleService, DialogFactoryService, SimpleMessageContentComponent,MediaShareResource } from '@app/app-legacy';
