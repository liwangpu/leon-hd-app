...
@Component({
  selector: 'app-organization-detail-owner-resetpassword-form',
  templateUrl: './organization-detail-owner-resetpassword-form.component.html',
  styleUrls: ['./organization-detail-owner-resetpassword-form.component.scss']
})
export class OrganizationDetailOwnerResetpasswordFormComponent implements OnInit, OnDestroy {
